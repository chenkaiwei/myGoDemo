...
require (
	...
	github.com/withfig/autocomplete-tools/integrations/cobra v0.0.0-20220719163525-554ac4127a1d // indirect
	github.com/zeromicro/antlr v0.0.1 // indirect
	github.com/zeromicro/ddl-parser v1.0.4 // indirect
	github.com/zeromicro/go-zero/tools/goctl v1.3.9 // indirect
